...
using RootProject.Services.Security;
using System;
...
namespace RootProject.Web.Controllers.Api
{
    ...
    public class ForumController : ApiController
    {
        ...
        //Post request passes in a paging object, desired data is the response
        ...
        {
            //Gets current user's id from the cookie
        ...
        public HttpResponseMessage PostComment(ForumCommentAddRequest model)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    //Calls profanity service 
                    model.Text = _profService.Cleanse(model.Text);
                    ItemResponse<int> resp = new ItemResponse<int>();
                    //Sends forum comment to database
