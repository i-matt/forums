...
namespace RootProject.Services
{
    public class ForumService : BaseService, IForumService
    {
        ...
        {
            //Creates dictionary of forum comments in order to insert data directly into a specific comment
            ...
            //Initializes two lists so we can insert things into them
                ...
                singleRecordMapper: delegate (IDataReader reader, short set)
                {
                    ...
                    switch (set)
                    {
                        ...
                        case 2:
                            ...
                            break;
                        //Gets list of files and adds them to their comment
                        case 3:
                            int fCommId = reader.GetSafeInt32(0);
                            int fileId = reader.GetSafeInt32(1);
                            CommentDict[fCommId].FileIds.Add(fileId);
                            break;
                        //Gets information for each person and adds them to their comment
                        case 4:
                        ...
                        case 5:
                            ...
                            break;
                        //Gets list of team members for this forum
                        case 6:
        ...
        public List<ForumStatusViewModel> GetAllForumsByPersonId(int personId)
        {
            ...
            //Creates dictionaries for statuses and the forums, so we can insert data to the correct location
